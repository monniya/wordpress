...
<?php if ($nirvana_mobile=="Enable") { // If mobile view is enabled ?>
...
$nirvanas= nirvana_get_theme_options();
  ...
  if (is_home() && $nirvana_frontpage!="Enable") {
    ...
    echo '<div id="breadcrumbs"><div id="breadcrumbs-box"><a href="' . $homeLink . '">' . $home . '</a> ' . $separator . ' ';
...
if($nirvana_searchbar['top'])  add_filter('wp_nav_menu_items','add_search_box_to_menu', 10, 2);
