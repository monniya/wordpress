			...
			<div <?php post_class('contact-form-page'); ?> id="post-<?php the_ID(); ?>">
				...
				<?php else : ?>
					...
					<div class="contact-form">
						<form action="<?php the_permalink(); ?>" id="rt-contact-form" class="form-validate" method="post">
							...
							<div class="control-group">
								<div class="controls">
									<label class="checkbox send-copy">
										<?php _re('Send copy to yourself'); ?> <input type="checkbox" name="rt-send-copy" id="rt-send-copy" value="true" />
									</label>
									<button class="btn btn-primary" type="submit" name="submit" id="submit"><?php _re('Send Email'); ?></button>
