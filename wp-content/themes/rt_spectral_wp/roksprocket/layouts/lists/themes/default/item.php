<?php
/**
 * @version   $Id: item.php 14348 2013-10-09 10:51:07Z arifin $
...
<?php if($parameters->get('lists_enable_accordion')): ?>
	<li <?php if (!$parameters->get('lists_enable_accordion') || $index == 0): ?>class="active" <?php endif;?>data-lists-item>
		...
		<?php endif; ?>
		<span class="sprocket-lists-item<?php if ($parameters->get('lists_enable_accordion')): ?> padding<?php endif; ?>" data-lists-content>
