...
function match_scripts() {
	...
	if ( 'off' !== _x( 'on', 'Raleway font: on or off', 'match' ) ) {
		...
		wp_register_style( 'match-raleway', $protocol . '://fonts.useso.com/css?family=Raleway' );
	...
	if ( 'off' !== _x( 'on', 'Roboto font: on or off', 'match' ) ) {
		...
		wp_register_style( 'match-roboto', $protocol . '://fonts.useso.com/css?family=Roboto:400,300italic,300,400italic,100,100italic' );
