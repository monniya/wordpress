		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '' ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					<div class="author">
						<?php if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'] ); ?>
						<?php printf( __( '%s <span class="says"></span>' ), sprintf( '<a href="#">%s</a> - ', get_comment_author_link() ) ); ?>
			...
			<div id="respond" class="comment-respond">
				...
				<?php else : ?>
					...
					<!--	<?php echo $args['comment_notes_after']; ?> -->
						<p class="form-submit">
							<input name="<?php echo esc_attr( $args['name_submit'] ); ?>" class="red"  type="submit" id="<?php echo esc_attr( $args['id_submit'] ); ?>" value="<?php echo esc_attr( $args['label_submit'] ); ?>" />
